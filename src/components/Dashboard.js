...
function FormElement(props) {
  ...
  return (
    <div className="form-group column col-1 col-sm-8 col-md-2 col-mx-auto">
    ...
    <div>
      <form onSubmit={start}>
        ...
        <div className="columns mt-2">
          <input type="submit" disabled={startDisabled} value="Start" className="btn btn-primary column col-2 col-sm-8 col-md-3 col-mx-auto"/>
        </div>
      </form>
      <div className="columns">
        <button onClick={stop} disabled={stopDisabled} className="btn btn-default mt-2 column col-2 col-sm-8 col-md-3 col-mx-auto">Stop</button>
      </div>
    </div>
  )
}
